...
$(function () {
    var html = '<div class="fixed_box">'
        /*+ '<a class="release-zb"><label></label><p>发布众包</p></a>'*/
        + '<a class="add-fixed"><label></label><p>提交</p></a>'
        /*+ '<a href="download/" class="load-fixed" target="_blank"><label></label><p>下载</p></a>'
        + '<a class="official"><label></label><p>官方微信</p><div class="official_pop"><p></p><span>扫一扫体验小程序</span></div></a>'*/
