...
function imgShow(e) {
    var o = $(e).offset().top,
        t = $(window).height(),
        n = 0;
    o < t ? $(e).attr("src", $(e).attr("data-src")) : $(".scrollArea").scroll(function() {
        n = $(this).scrollTop(), o <= n + t - 200 && $(e).attr("src", $(e).attr("data-src"))
    })
}
$(function() {
    function e(e) {
        var o = e + "=",
            t = "";
        return document.cookie.length > 0 && (offset = document.cookie.indexOf(o), offset != -1 && (offset += o.length, end = document.cookie.indexOf(";", offset), end == -1 && (end = document.cookie.length), t = unescape(document.cookie.substring(offset, end)))), t
    }
    for (var o = $(".navinner .list a"), t = 0, n = 0; n < o.length; n++) t += $(o[n]).outerWidth();
    ...
    "" != e("index-tips") && /(.*)+safari(.*)+/.test(a) ? $(".addToScreen").show() : $(".addToScreen").hide(), $(".m-container").dragViewForIos({
        touchSub: ".m-sub"
    })
}),
    function(e) {
        e.fn.dragViewForIos = function(o) {
            ...
            o && e.extend(t, o), this.each(function(o, n) {
                var a = Math.floor(e(n).outerHeight()),
                    r = Math.floor(e(t.touchSub).outerHeight());
                e(n).scroll(function() {
                    0 == e(n).scrollTop() && e(n).scrollTop(1), e(n).scrollTop() == r - a && e(n).scrollTop(e(n).scrollTop() - 1)
                })
            })
        }
    }(jQuery),
    function(e) {
        e.fn.copyAndShow = function(o) {
            ...
            o && e.extend(t, o), this.each(function(o) {
                new Clipboard(this).on("success", function(o) {
                    var o = o || window.event;
                    t.callback && t.callback(!0), e(".copy-laye-show-1").show(), setTimeout(function() {
                    ...
                    var o = o || window.event;
                    t.callback && t.callback(!1), e(".copy-laye-show-2").show(), setTimeout(function() {
                        e("textarea[readonly]").remove()
                    }, 200), e(".copy-laye").css("height", e(".page").height()).show(), e("body").attr("ontouchmove", "return false"), o.clearSelection()
                })
            })
        ...
        e.fn.loadToBottom = function(o) {
            ...
            o && e.extend(t, o), this.each(function(o) {
                ...
                e(this).scroll(function() {
                    a && e(n).scrollTop() >= Math.floor((e(t.targetHeight).outerHeight() - e(window).height()) * t.scale) && a && (a = !1, t.callback ? t.callback() : console.log("如需要，请设置callback"), setTimeout(function() {
                        a = !0
                    }, 500))
                })
            })
